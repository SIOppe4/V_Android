...
public class BateauListAdapter extends ArrayAdapter<Bateau> {
    List<Bateau> b;
    Context c;
    int r;

    public BateauListAdapter(Context context, int resource, ArrayList<Bateau> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView nom_bateau = (TextView) v.findViewById(R.id.nom_client);

        nom_bateau.setText(el.getNom());
